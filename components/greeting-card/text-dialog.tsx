...
const TextDialog: React.FC<Props> = ({ session, open, setOpen, handleRegenerateText, onGreetingChange }) => {
  ...
  const onSave = useCallback(async (greeting:string) => {
  ...
  return <Dialog fullScreen={fullScreen}
    ...
    <DialogContent>
      ...
      <ToolbarContainer data-id="toolbar-generate">
        <ToolbarButton color={"primary"} size="large" onClick={generateText}>

          <TextFieldsIcon />
          <ToolbarText>Regenerate Wish Text</ToolbarText>
        </ToolbarButton>
      </ToolbarContainer>
    ...
    <DialogActions>
      ...
      {false && <Button onClick={() => generateText()}>Generate</Button>}
      <Button onClick={() => {console.log("onSave");onSave(greeting)}}>Save</Button>
    </DialogActions>
